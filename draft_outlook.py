...
with open("/Users/gregmontoya/AntiGravity Workspaces/CSL-Resale-Advantage/open_outlook.scpt", "w") as f:
    f.write(applescript)

print("Generated AppleScript. Running...")
result = subprocess.run(["osascript", "/Users/gregmontoya/AntiGravity Workspaces/CSL-Resale-Advantage/open_outlook.scpt"], capture_output=True, text=True)
