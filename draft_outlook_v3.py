...
Check out the new website here: <a href="https://www.centerstreetlending.com/resale-advantage">https://www.centerstreetlending.com/resale-advantage</a><br>
...
with open("/Users/gregmontoya/AntiGravity Workspaces/CSL-Resale-Advantage/open_outlook_v3.scpt", "w") as f:
    f.write(applescript)

print("Generated V3 AppleScript ready to run.")
