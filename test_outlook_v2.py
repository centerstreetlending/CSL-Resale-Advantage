...
with open("/Users/gregmontoya/AntiGravity Workspaces/CSL-Resale-Advantage/test_outlook_v2.scpt", "w") as f:
    f.write(applescript)

print("Generated test script v2.")
subprocess.run(["osascript", "/Users/gregmontoya/AntiGravity Workspaces/CSL-Resale-Advantage/test_outlook_v2.scpt"])
