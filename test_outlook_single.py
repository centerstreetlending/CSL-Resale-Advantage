...
with open("/Users/gregmontoya/AntiGravity Workspaces/CSL-Resale-Advantage/test_outlook.scpt", "w") as f:
    f.write(applescript)

print("Generated test script.")
subprocess.run(["osascript", "/Users/gregmontoya/AntiGravity Workspaces/CSL-Resale-Advantage/test_outlook.scpt"])
