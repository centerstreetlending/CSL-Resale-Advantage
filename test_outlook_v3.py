...
name = "Alec Ralph"
username = "aralph"
email = "aralph@centerstreetlending.com"
first_name = "Alec"
...
Thanks for joining the information session last week on the new CSL Resale Advantage program!<br><br>
...
with open("/Users/gregmontoya/AntiGravity Workspaces/CSL-Resale-Advantage/test_outlook_v3.scpt", "w") as f:
    f.write(applescript)

print("Generated test script v3.")
subprocess.run(["osascript", "/Users/gregmontoya/AntiGravity Workspaces/CSL-Resale-Advantage/test_outlook_v3.scpt"])
